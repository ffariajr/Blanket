...
// the literal "guid"/"mine"/"shared" as an id.
$router->add('GET', '/api/spreadsheets/guid/{guid}', fn (Request $r) => (new SpreadsheetController())->byGuid($r));
$router->add('GET', '/api/spreadsheets/mine', fn (Request $r) => (new SpreadsheetController())->mine($r));
$router->add('GET', '/api/spreadsheets/shared', fn (Request $r) => (new SpreadsheetController())->shared($r));
...
$router->add('POST', '/api/spreadsheets/{id}/find-replace', fn (Request $r) => (new SpreadsheetController())->findReplace($r));
